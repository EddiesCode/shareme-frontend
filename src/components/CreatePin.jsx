...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-5 lg:h-4/5">
      {fields && (
        <p className="mb-5 text-red-500 transition-all duration-150 ease-in">
          Please fill in all the fields
        </p>
      )}
      <div className="flex flex-col items-center justify-center w-full p-3 bg-white lg:flex-row lg:p-5 pg:w-4/5">
          ...
          <div className="flex flex-col items-center justify-center w-full p-3 border-2 border-gray-300 border-dotted h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button
                  type="button"
                  className="absolute p-3 text-xl duration-500 ease-in-out bg-white rounded-full outline-none cursor-pointer bottom-3 right-3 hover:shadow-md transition-full"
          ...
          <div className="flex flex-col">
            <div>
              ...
              <select
                ...
                className="w-4/5 p-2 text-base border-gray-200 rounded-md outline-none cursor-pointer order-b-2"
              >
